        ...
        {open ? (
          ...
          <>
            <div className="sidebar-section">
              <ul>
                <li>
                  <a href="#bookmarks" className="sidebar-link active" title="Bookmarks">📚</a>
                </li>
                <li>
                  <a href="#collections" className="sidebar-link" title="Collections">📁</a>
                </li>
                <li>
                  <a href="#tags" className="sidebar-link" title="Tags">🏷️</a>
                </li>
                <li>
                  <a href="#recent" className="sidebar-link" title="Récents">⏰</a>
                </li>
              </ul>
            </div>
            <div className="sidebar-section">
              <ul>
                <li>
                  <a href="#import" className="sidebar-link" title="Importer">📥</a>
                </li>
                <li>
                  <a href="#export" className="sidebar-link" title="Exporter">📤</a>
                </li>
                <li>
                  <a href="#stats" className="sidebar-link" title="Statistiques">📊</a>
                </li>
              </ul>
            </div>
          </>
